...
const About = ({htmlIcon, cssIcon, jsIcon, reactIcon, javaIcon, postgresSqlIcon}) => {
  const techIcon = [htmlIcon, cssIcon, jsIcon, reactIcon, javaIcon, postgresSqlIcon];
  ...
  return (
    <div id="About" className="about-container">
      <div className='about-me'>
        ...
        <p>I'm in the middle of a career change from being a Doctor of Physical Therapy to Software Developer! I always loved solving difficult problems, but now instead of the human body, I will solve them online.</p>
